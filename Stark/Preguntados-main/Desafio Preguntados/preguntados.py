...
imagen = pygame.image.load("/Users/iargonzalez/Downloads/Preguntados-main/Desafio Preguntados/preguntados.png")
imagen = pygame.transform.scale(imagen,(275,200))
imagen_fondo = pygame.image.load("/Users/iargonzalez/Downloads/Preguntados-main/Desafio Preguntados/PERSONAJES.png")
imagen_fondo = pygame.transform.scale(imagen_fondo,(1450,650))
sonido_correcto = pygame.mixer.Sound("/Users/iargonzalez/Downloads/Preguntados-main/Desafio Preguntados/correct.mp3")
sonido_incorrecto = pygame.mixer.Sound("Desafio Preguntados/fail.mp3")
fuente = pygame.font.Font('Desafio Preguntados/HVD Fonts  MikadoUltra.otf', 30)
